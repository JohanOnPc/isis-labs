...
bridge fdb add 00:00:00:00:00:00 dev vxlan100 dst 10.0.0.3 self extern_learn

#L3VNI
ip link add vxlan1100 type vxlan id 1100 local 10.0.0.4 dstport 4789 nolearning
ip link set vxlan1100 addr aa:bb:cc:dd:ee:04
