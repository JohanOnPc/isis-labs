...
ip link add vxlan1000 type vxlan id 1000 local 10.0.0.1 dstport 4789
...
ip link add vxlan1001 type vxlan id 1001 local 10.0.0.1 dstport 4789
...
bridge fdb append 00:00:00:00:00:00 dev vxlan1001 dst 10.0.0.2